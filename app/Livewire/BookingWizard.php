...
class BookingWizard extends Component
{
    ...
    public function confirmBooking()
    {
        ...
        // Check User Credits (Fail-fast)
        $student = auth()->user();
        if ($student->credits < 1) {
            $this->addError('booking', "Insufficient credits. You need 1 credit to book this class.");
            return;
        }
        ...
        try {
            ...
            $this->addError('booking', 'An error occurred while confirming your booking. Please try again.');
        }
    }
